        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex flex-col items-start mb-4 md:mb-0">
            ...
            <p className="text-sm max-w-lg">
              Fairytalez.com is the world's largest collection of fairy tales, fables, and folktales. 
              Discover thousands of classic tales plus new stories by fairy tale fans. 
              Join now to publish your own tales, get feedback from readers, and enter writing competitions.
            </p>
            <p className="font-semibold mt-2">© 2025 Fairytalez.mystic melody. All Rights Reserved.</p>
          </div>
